...
const int SAMPLING_RATE_HZ = 100;  // 50 Hz sampling rate
...
void IRAM_ATTR onSampleTimer(void* arg) {
  ...
  readSensors(measurementMode, value1, value2, value3);
  
  // Store the values directly
  storeDataPoint(elapsed_ms, measurementMode, value1, value2, value3);
}
